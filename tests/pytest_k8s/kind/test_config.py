...
class TestKindClusterConfig:
    ...
    def test_validation_no_nodes(self):
        ...
        with pytest.raises(KindClusterConfigError, match="At least one node must be configured"):
    ...
    def test_validation_no_control_plane(self):
        ...
        with pytest.raises(KindClusterConfigError, match="At least one control-plane node is required"):
