...
class TestKindNotInstalledError:
    ...
    def test_default_initialization(self):
        ...
        assert error.recovery_suggestion == "Install kind from https://kind.sigs.k8s.io/docs/user/quick-start/#installation"
...
class TestDockerNotRunningError:
    ...
    def test_default_initialization(self):
        ...
        assert error.recovery_suggestion == "Start Docker Desktop or Docker daemon, or install Docker from https://docs.docker.com/get-docker/"
...
class TestKindClusterTimeoutError:
    ...
    def test_initialization_with_timeout(self):
        ...
        assert error.recovery_suggestion == f"Try increasing the timeout value (currently {timeout} seconds) or check system resources"
