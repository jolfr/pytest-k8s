...
class PortMapping:
    ...
    def __post_init__(self):
        ...
        if not (1 <= self.container_port <= 65535):
            raise KindClusterConfigError(f"Invalid container port: {self.container_port}")
...
class KindClusterConfig:
    ...
    def add_port_mapping(self, container_port: int, host_port: int, 
                        protocol: str = "TCP", listen_address: str = "0.0.0.0") -> None:
